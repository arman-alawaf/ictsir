                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{'studentreviews'==request()->path()?'active':''}}" href="{{ url('studentreviews') }}">{{ __('Student Review') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{'notices'==request()->path()?'active':''}}" href="{{ url('notices') }}">{{ __('Notices') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{'apps'==request()->path()?'active':''}}" href="{{ url('apps') }}">{{ __('Settings') }}</a>
                            </li>
                            @endif
