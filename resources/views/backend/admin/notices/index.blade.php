      ...
      <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:99999;">
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            ...
            <form class="afterSubmitForm" action="{{url('notices')}}" method="post" enctype="multipart/form-data"> @csrf
          ...
          <table class="table table-responsive table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="nowrap">@if($data->image)<img style="height:60px;width:auto;" src="{{asset('images/notices/'.$data->image)}}" alt="{{$data->title}}">@endif</td>
                <td class="nowrap">
              ...
              <div class="modal fade" id="Edit{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:99999;">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <form class="afterSubmitForm2" action="{{url('notices/'.$data->id)}}" method="post" enctype="multipart/form-data"> @csrf @method('put')
                    <div class="modal-body">
                      <div class="row">
                          ...
                          <div class="col-12 mb-3">
                              <label for="image">Image <span class="text-danger fw-bold">*</span></label>
                              <img style="height:100px;width:auto;" src="{{asset('images/notices/'.$data->image)}}" alt="{{$data->name}}">
                              <input type="file" name="image" id="image" class="form-control my-2">
                          </div>
              ...
              <div class="modal fade" id="Delete{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:99999;">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <form class="afterSubmitForm3" action="{{url('notices/'.$data->id)}}" method="post" enctype="multipart/form-data"> @csrf @method('delete')
